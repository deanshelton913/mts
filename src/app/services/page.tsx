                ...
                <ul className="space-y-3">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start">
                      <CheckCircleIcon className="h-6 w-6 text-purple-500 mr-3 flex-shrink-0 mt-0.5" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {process.map((step, index) => (
              <div key={index} className="text-center">
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full w-16 h-16 flex items-center justify-center text-xl font-bold mx-auto mb-6">
                  {step.step}
                </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-purple-200">20+ years of experience in the technology industry, with deep understanding of small business needs.</p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Local Focus</h3>
                  <p className="text-purple-200">Based in Mukilteo, we understand the local business landscape and provide personalized service.</p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Cost-Effective</h3>
                  <p className="text-purple-200">Competitive pricing designed for small business budgets without compromising quality.</p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Ongoing Support</h3>
                  <p className="text-purple-200">We don&apos;t just build solutions - we provide ongoing support and maintenance.</p>
                </div>
              </div>
            </div>
