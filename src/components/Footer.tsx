        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>Mukilteo, WA</p>
              <p>
                <a href="mailto:info@mukilteotech.com" className="hover:text-white transition-colors">
                  info@mukilteotech.com
                </a>
              </p>
              <p>
                <a href="tel:+1-425-555-0123" className="hover:text-white transition-colors">
                  (425) 555-0123
                </a>
              </p>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Mukilteo Technical Solutions. All rights reserved.
            </p>
